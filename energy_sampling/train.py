...
def train(name, energy, buffer, buffer_ls, epoch_offset, log_Z_est=None, pre_model=None, teacher_samples=None):
        ...
        for i in range(args.round):
            ...
            if i == 0:
                ...
                if args.student_mode == 'reinit':
                    student_model, rnd_model, global_epochs = train(name, energy, buffer, buffer_ls, epoch_offset=global_epochs, log_Z_est=student_model.flow_model, pre_model=None, teacher_samples=teacher_samples)
                    print(f"After TB, total energy calls: {energy.energy_call_count}")
                    ...
                    student_model, rnd_model, global_epochs = train(name, energy, buffer, buffer_ls, epoch_offset=global_epochs, log_Z_est=student_model.flow_model, pre_model=student_model, teacher_samples=teacher_samples)
                    print(f"After TB, total energy calls: {energy.energy_call_count}")
